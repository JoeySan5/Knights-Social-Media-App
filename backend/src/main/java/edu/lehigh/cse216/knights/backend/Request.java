...
/**
 * Generic Request type. Contains data which should be given in any request, like a session key.
 * There are some exceptions when a sessionKey is not checked, such as trying to log in.
 * 
...
public abstract class Request {
  ...
  /**
   * session key for the current frontend session. Generated by the backend and provieded
   * to frontend upon a successful authentication for logging in.
   */
  public String sessionKey;

  /**
   * Requests for User related requests. E.g. Viewing or Editing a users profile page.
   */
  public class UserRequest extends Request {

    /**
     * The unique identifier for the requested user. This is originally provided by the google
     * API, then is stored as the primary key for a user in the database.
     * This field should be checked aginst the requester's userId, to check for user's edit and delete permission.
     */
    public String mId;
  ...
  /*
   * Request format for Comment related requests, e.g. creating or editing a comment.
   */
